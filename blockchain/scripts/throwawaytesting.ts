...
const uri = {
    elf: "https://ipfs.filebase.io/ipfs/QmPHjCGjUBv5ZbzMMZrcUv6rahDHwPfnsJ3wtLkpBPAQPt",
    hammer: "https://ipfs.filebase.io/ipfs/QmSmx4nHHT52y3J6VhYYK4Zwc5wxBj4q9mtahpfphhP2Jm",
    warrior: "https://ipfs.filebase.io/ipfs/QmQC8AhtuR5REMgPQ4U2fPwQCcdRyomstjucNRhd4WXiKm",
    sword: "https://ipfs.filebase.io/ipfs/QmZtGwzymqv9SzNvVBuxV2SnxX9SzsP2DBZWiA2Kq7rAgb"
}
...
const main = async () => {
    ...
    console.log('\nminting...');
    const mint = await nftContract.safeMint(walletAddress, uri.sword);
    ...
    // console.log('\nlending...');
    // const price = ethers.utils.parseEther('0.00000018');
    // const tx = await contract.lendNFT(nft.address, tokenId, price, 72*60);
